...
namespace WebSite.Controllers
{
    ...
    public class TeamController : BaseController
    {
        ...
        {
            //var userTeamPos =_userTeamPosManager.GetUsersTeamPosByTeamIdAndUserId(new Guid(id), CurrentUserId);
            ...
            //    ViewBag.TeamPmId = CurrentUserId;
            //    ViewBag.IsUserAdmin = isAdmin;
            //}
            //else
            //{
            //    ViewBag.UserPermission = false;
            //    ViewBag.TeamPmId = null;
            //}
            //var test = ViewBag.TeamPmId??"22";
