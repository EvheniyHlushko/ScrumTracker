...
namespace WebSite.Controllers
{
    ...
    public class SprintController : BaseController
    {
        ...
        public JsonResult CheckName(Guid? id, string name)
        {
            ...
            {
                res = false;
                var sprintExist = sprintTemp.FirstOrDefault();
                if (id != null)  // if - edit project
                {
                    if (sprintExist.Id == id)
                    {
                        res = true;
                    }
                }
        ...
        public ActionResult Edit(SprintModel model)
        {
            try
            {
                //var sprintTemp = _sprintManager.GetSprintByName(model.Name);
                //var flag = true;  //  if not error
                //if (sprintTemp != null)
                //{
                //    var sprintFirst = sprintTemp.FirstOrDefault();

                //    if (sprintFirst.Id != model.Id)
                //    {
                //        ModelState.AddModelError("Name", "The sprint with this name exists");
                //        flag = false;  // error
                //    }
                //}
